...
**Tests**: Test tasks are REQUIRED by constitution. Include unit/integration/contract
tests as applicable to each story and change surface.
...
- [ ] T005 [P] Define baseline performance measurement approach for feature scope
...
- [ ] T012 Define UX consistency checklist for impacted roles and screens
- [ ] T013 Define measurable performance budgets and pass/fail thresholds
...
- [ ] T016 [P] [US1] Unit tests for domain/service logic in tests/unit/test_[name].py
...
- [ ] T023 [US1] Validate UX consistency for role flows and responsive states
- [ ] T024 [US1] Validate feature performance against defined budgets
...
- [ ] T027 [P] [US2] Unit tests for domain/service logic in tests/unit/test_[name].py
...
- [ ] T032 [US2] Validate UX consistency for role flows and responsive states
- [ ] T033 [US2] Validate feature performance against defined budgets
...
- [ ] T036 [P] [US3] Unit tests for domain/service logic in tests/unit/test_[name].py
...
- [ ] T040 [US3] Validate UX consistency for role flows and responsive states
- [ ] T041 [US3] Validate feature performance against defined budgets
...
- [ ] TXXX [P] Close test coverage gaps in tests/unit/, tests/integration/, tests/contract/
