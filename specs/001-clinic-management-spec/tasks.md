...
- [ ] T005 Define shared role and status constants in `frontend/src/utils/roles.ts` and `frontend/src/utils/statuses.ts`
- [ ] T006 [P] Build shared responsive shell and navigation framework in `frontend/src/components/layout/` for Android, iOS, and Windows targets
